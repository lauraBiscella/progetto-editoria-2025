...
if __name__ == "__main__":
    markdown_file = 'Relazione.md'  # Sostituisci con il tuo file markdown
    larghezza_nuova = 250 # La larghezza desiderata per le immagini (in pixel)
    altezza_nuova = 420 # L'altezza desiderata per le immagini (in pixel)
